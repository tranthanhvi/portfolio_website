...
})(["background:transparent;border-radius:7px;border:2.5px solid #1d1e4e;color:#1d1e4e;margin:0 0 1rem 0;padding:0.25em 1em;cursor:pointer;&:hover{background:#78e185;opacity:1;}"]); // export const ButtonBack = styled.div`
