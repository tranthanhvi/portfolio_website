...
})(["display:grid;grid-template-columns:repeat(auto-fill,minmax(400px,1fr));padding:3rem;place-items:center;column-gap:1rem;row-gap:2rem;@media ", "{display:flex;flex-direction:column;padding:2rem;padding-bottom:0;margin-botton:4rem;}"], function (props) {
  return props.theme.breakpoints.sm;
});
