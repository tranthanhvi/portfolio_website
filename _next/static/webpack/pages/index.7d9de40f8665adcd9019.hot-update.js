...
})(["display:grid;grid-template-columns:repeat(auto-fill,minmax(250px,1fr));padding:3rem;place-items:center;column-gap:1rem;row-gap:2rem;margin-bottom:4rem;@media ", "{display:flex;flex-direction:column;padding:2rem;padding-bottom:0;margin-bottom:4rem;}"], function (props) {
  return props.theme.breakpoints.sm;
});
