...
})(["display:grid;grid-template-columns:repeat(auto-fill,minmax(200px,1fr));padding:3rem;place-items:center;column-gap:1rem;row-gap:2rem;@media ", "{display:flex;flex-direction:column;padding:2rem;padding-bottom:0;}"], function (props) {
  return props.theme.breakpoints.sm;
});
