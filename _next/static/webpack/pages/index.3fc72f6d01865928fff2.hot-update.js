...
})(["display:flex;background:transparent;border-radius:7px;border:2.5px solid #1d1e4e;color:#1d1e4e;margin:0 0 1rem 0;padding:0.25em 1em;cursor:pointer;&:hover{background:rgb(120,225,133,0.75);}"]); // export const ButtonBack = styled.div`
